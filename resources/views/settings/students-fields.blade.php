...
@section('title', 'Student Field Settings')
@section('heading', 'Student Field Settings')
...
@php
$fields = [
    ['id'=>1,'label'=>'Full Name',      'type'=>'Text',  'required'=>true, 'visible'=>true],
    ['id'=>2,'label'=>'Email',          'type'=>'Email', 'required'=>true, 'visible'=>true],
    ['id'=>3,'label'=>'Phone',          'type'=>'Phone', 'required'=>true, 'visible'=>true],
    ['id'=>4,'label'=>'Date of Birth',  'type'=>'Date',  'required'=>true, 'visible'=>true],
    ['id'=>5,'label'=>'Course',         'type'=>'Select','required'=>true, 'visible'=>true],
    ['id'=>6,'label'=>'Guardian Name',  'type'=>'Text',  'required'=>false,'visible'=>true],
    ['id'=>7,'label'=>'Blood Group',    'type'=>'Select','required'=>false,'visible'=>false],
    ['id'=>8,'label'=>'Previous School','type'=>'Text',  'required'=>false,'visible'=>true],
];
@endphp
