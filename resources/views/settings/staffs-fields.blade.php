...
@section('title', 'Staff Field Settings')
@section('heading', 'Staff Field Settings')
...
$fields = [
    ...
    ['id'=>4,'label'=>'Date of Birth',   'type'=>'Date',    'required'=>false,'visible'=>true],
    ['id'=>5,'label'=>'Department',      'type'=>'Select',  'required'=>true, 'visible'=>true],
    ['id'=>6,'label'=>'Qualification',   'type'=>'Text',    'required'=>false,'visible'=>true],
    ['id'=>7,'label'=>'Emergency Contact','type'=>'Phone',  'required'=>false,'visible'=>false],
];
@endphp
