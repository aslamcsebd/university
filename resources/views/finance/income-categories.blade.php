...
@section('heading', 'Income Categories')
...
@php
$cats = [
    ['id'=>1,'name'=>'Fees',       'description'=>'Student fee collections',    'count'=>12,'status'=>'Active'],
    ['id'=>2,'name'=>'Rent',       'description'=>'Property and space rentals',  'count'=>3, 'status'=>'Active'],
    ['id'=>3,'name'=>'Donation',   'description'=>'Donations and grants',        'count'=>5, 'status'=>'Active'],
    ['id'=>4,'name'=>'Transport',  'description'=>'Transport fee income',        'count'=>4, 'status'=>'Active'],
    ['id'=>5,'name'=>'Hostel',     'description'=>'Hostel accommodation income', 'count'=>6, 'status'=>'Active'],
    ['id'=>6,'name'=>'Miscellaneous','description'=>'Other income sources',      'count'=>2, 'status'=>'Active'],
];
@endphp
