...
@section('title', 'Postal Types')
@section('heading', 'Postal Types')
...
@php
$items = [
    ['id'=>1,'name'=>'Letter',   'count'=>18,'status'=>'Active'],
    ['id'=>2,'name'=>'Parcel',   'count'=>7, 'status'=>'Active'],
    ['id'=>3,'name'=>'Courier',  'count'=>12,'status'=>'Active'],
    ['id'=>4,'name'=>'Document', 'count'=>9, 'status'=>'Active'],
    ['id'=>5,'name'=>'Package',  'count'=>4, 'status'=>'Active'],
];
@endphp
<div class="card" style="overflow:hidden;">
    <table>
        <thead><tr><th>#</th><th>Name</th><th>Records</th><th>Status</th><th>Action</th></tr></thead>
        <tbody>
        @foreach($items as $i)
        <tr>
