...
@section('heading', 'Complain Types')
...
@php
$items = [
    ['id'=>1,'name'=>'Academic',   'count'=>8, 'status'=>'Active'],
    ['id'=>2,'name'=>'Facility',   'count'=>5, 'status'=>'Active'],
    ['id'=>3,'name'=>'Fee',        'count'=>4, 'status'=>'Active'],
    ['id'=>4,'name'=>'Behavioral', 'count'=>3, 'status'=>'Active'],
    ['id'=>5,'name'=>'Staff',      'count'=>2, 'status'=>'Active'],
    ['id'=>6,'name'=>'Other',      'count'=>1, 'status'=>'Active'],
];
@endphp
<div class="card" style="overflow:hidden;">
    <table>
        <thead><tr><th>#</th><th>Name</th><th>Complains</th><th>Status</th><th>Action</th></tr></thead>
        <tbody>
        @foreach($items as $i)
        <tr>
