...
@section('heading', 'Complain Sources')
...
@php
$items = [
    ['id'=>1,'name'=>'Student', 'count'=>12,'status'=>'Active'],
    ['id'=>2,'name'=>'Parent',  'count'=>8, 'status'=>'Active'],
    ['id'=>3,'name'=>'Staff',   'count'=>3, 'status'=>'Active'],
    ['id'=>4,'name'=>'Anonymous','count'=>2,'status'=>'Active'],
];
@endphp
